...
- The design summary should clearly distinguish the board-level hardware from any optional higher-level Raspberry Pi algorithm layer.
...
- Treat Raspberry Pi connectivity as optional board expansion rather than the defining feature of the PCB itself.
